...
function generateToken(data) {
    ...
    var sha256 = crypto.createHmac("sha256", random + config.salt + timestamp);
    return sha256.update(data).digest("base64");
}

exports.grantClientToken = function (clientId, clientSecret, cb) {

    Eventure.authenticateUser(clientId, clientSecret, function(err, user){
        if(!err){
