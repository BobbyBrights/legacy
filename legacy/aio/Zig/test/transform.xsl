...
<xsl:template match="testsuites">
    ...
    <xsl:template name="summary">
        ...
        Note: <i>failures</i> are anticipated and checked for with assertions while <i>errors</i> are unanticipated.
         ...
         <h2>Screenshot</h2>
         <img id="summarySShot"></img>
         <script>
         	document.getElementById('summarySShot').src = window.location.pathname.split('/').pop().split('.')[0]+'.png';
         </script>
    </xsl:template>
...
<xsl:template name="pageHeader">
    <h1><xsl:value-of select="./testsuite[1]/@name"/> - Unit Test Results</h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
...
<xsl:template name="testcase.test.header">
    <tr valign="top">
        ...
        <th width="80%">Type</th>
        <th nowrap="nowrap">Time(s)</th>
        <th nowrap="nowrap">Screenshot(s)</th>
    </tr>
</xsl:template>
