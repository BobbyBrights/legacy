...
public class ErrorMessagesResponse extends GeneralResponse {

	@JsonProperty
	private ArrayList<ErrorResponse> messages = new ArrayList<ErrorResponse>();
	
	public ErrorMessagesResponse(ErrorResponse er){
		messages.add(er);
		this.setStatus("failure");
	}
	
	public void addError(ErrorResponse er){
		messages.add(er);
	}
