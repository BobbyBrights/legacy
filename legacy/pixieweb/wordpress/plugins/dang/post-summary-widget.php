<?php
/*
Plugin Name:  Post Summary Widget
Plugin URI: http://www.techfairytales.com/categories/wordpress-plugins
Description: This plugin will show latest post content given post ID.
Version: 1.0
...
add_action( 'widgets_init', create_function( '', 'return register_widget("Post_Summary");' ) );


class Post_Summary extends WP_Widget {
	/** constructor */

	function __construct() {
		$widget_ops = array('classname' => 'Post_Summary', 'description' => __( 'This plugin will show latest post content given post ID.') );
		parent::__construct('post_summary', __('Post Summary'), $widget_ops);
	}
