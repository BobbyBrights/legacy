...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
		...
		onComplete: function(event, queueID, fileObj, response, data) {
			...
			$('#gs-table-slides #file-uploaded-'+rowID).empty().append('<span style="color:red;">There was a problem uploading the file! Check permissions.</span>');
		    }
		}
	    });
	}
...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
		...
		onComplete: function(event, queueID, fileObj, response, data) {
			...
			$('#pm-table-slides #file-uploaded-'+rowID).empty().append('<span style="color:red;">There was a problem uploading the file! Check permissions.</span>');
		    }
		}
	    });
	}
...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
		...
		onComplete: function(event, queueID, fileObj, response, data) {
			...
			$('#pm2-table-slides #file-uploaded-'+rowID).empty().append('<span style="color:red;">There was a problem uploading the file! Check permissions.</span>');
		    }
		}
	    });
	}
...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
		...
		onComplete: function(event, queueID, fileObj, response, data) {
			...
			$('#c1-table-slides #file-uploaded-'+rowID).empty().append('<span style="color:red;">There was a problem uploading the file! Check permissions.</span>');
		    }
		}
	    });
	}
...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
		...
		onComplete: function(event, queueID, fileObj, response, data) {
			...
			$('#c2-table-slides #file-uploaded-'+rowID).empty().append('<span style="color:red;">There was a problem uploading the file! Check permissions.</span>');
		    }
		}
	    });
	}
...
jQuery(document).ready(function($) {
	...
	function addUploader(tableOrRow, rowID) {
		...
		onComplete: function(event, queueID, fileObj, response, data) {
			...
			$('#c3-table-slides #file-uploaded-'+rowID).empty().append('<span style="color:red;">There was a problem uploading the file! Check permissions.</span>');
		    }
		}
	    });
	}
