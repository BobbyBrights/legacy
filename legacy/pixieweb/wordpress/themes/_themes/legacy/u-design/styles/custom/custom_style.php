...
<?php if ($udesign_options['c1_remove_image_frame'] == 'yes') : ?>
    ...
    #c1-header .c1-slideshow { padding: 10px; }
...
#c2-slider .slide-desc p { font-size:<?php echo $udesign_options['c2_slider_text_size']; ?>em; line-height:<?php echo $udesign_options['c2_slider_text_line_height']; ?>; }
...
<?php if ($udesign_options['one_continuous_bg_img'] != '') : 
    ...
    #top-wrapper, #gs-header, #piecemaker-header, #c1-header, #c2-header, #c3-header,
