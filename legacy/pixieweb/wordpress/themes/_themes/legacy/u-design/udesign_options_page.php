...
define('UDESIGN_PAGE_OPTIONS', 'udesign-page-options');
global $udesign_options, $google_webfonts;
$udesign_options  = get_option('udesign_options');
$google_webfonts = array('Abel','Abril+Fatface','Aclonica','Actor','Adamina','Aldrich','Alice','Alike','Allan:bold','Allerta','Allerta+Stencil','Amaranth','Andika','Annie+Use+Your+Telescope','Anonymous+Pro','Antic','Anton','Architects+Daughter','Arimo','Artifika','Arvo','Asset','Astloch','Aubrey','Bangers','Bentham','Bevan','Bigshot+One','Black+Ops+One','Bowlby+One','Bowlby+One+SC','Brawler','Buda:light','Cabin','Cabin+Sketch:bold','Cabin:bold','Calligraffitti','Candal','Cantarell','Cardo','Carme','Carter+One','Caudex','Cedarville+Cursive','Changa+One','Cherry+Cream+Soda','Chewy','Coda:800','Comfortaa','Coming+Soon','Copse','Corben:bold','Cousine','Coustard','Covered+By+Your+Grace','Crafty+Girls','Crimson','Crushed','Cuprum','Damion','Dancing+Script','Dawning+of+a+New+Day','Days+One','Delius','Delius+Swash+Caps','Delius+Unicase','Didact+Gothic','Dorsa','Droid Sans','Droid Sans Mono','Droid Serif','EB+Garamond','Expletus+Sans','Fanwood+Text','Federo','Fontdiner+Swanky','Forum','Francois+One','Gentium+Basic','Gentium+Book+Basic','Geo','Geostar','Geostar+Fill','Give+You+Glory','Gloria+Hallelujah','Goblin+One','Goudy+Bookletter+1911','Gravitas+One','Gruppo','Hammersmith+One','Holtwood+One+SC','Homemade+Apple','IM Fell','Inconsolata','Indie+Flower','Irish+Growler','Istok+Web','Josefin Sans Std Light','Josefin+Sans','Josefin+Slab','Judson','Julee','Jura','Just+Another+Hand','Just+Me+Again+Down+Here','Kameron','Kelly+Slab','Kenia','Kranky','Kreon','Kristi','La+Belle+Aurore','Lato','League+Script','Leckerli+One','Lekton','Limelight','Lobster','Lobster+Two','Lora','Love+Ya+Like+A+Sister','Loved+by+the+King','Luckiest+Guy','Maiden+Orange','Mako','Marvel','Maven+Pro','Meddon','MedievalSharp','Megrim','Merienda+One','Merriweather','Metrophobic','Michroma','Miltonian','Miltonian+Tattoo','Modern+Antiqua','Molengo','Monofett','Monoton','Montez','Mountains+of+Christmas','Muli','Neucha','Neuton','News+Cycle','Nixie+One','Nobile','Nova+Round','Numans','Nunito','OFL Sorts Mill Goudy TT','OFL Standard TT','Orbitron','Oswald','Over+the+Rainbow','Ovo','PT Sans','PT Sans Narrow','PT+Serif','PT+Serif+Caption','Pacifico','Passero+One','Patrick+Hand','Paytone+One','Permanent+Marker','Philosopher','Play','Playfair+Display','Podkova','Pompiere','Prata','Prociono','Puritan','Quattrocento','Quattrocento+Sans','Questrial','Radley','Raleway:100','Rationale','Redressed','Reenie Beanie','Rochester','Rock+Salt','Rokkitt','Rosario','Ruslan+Display','Schoolbell','Shadows+Into+Light','Shanti','Short+Stack','Sigmar+One','Six+Caps','Slackey','Smokum','Smythe','Sniglet:800','Snippet','Sorts+Mill+Goudy','Special+Elite','Stardos+Stencil','Sue+Ellen+Francisco','Sunshiney','Swanky+and+Moo+Moo','Syncopate','Tangerine','Tenor+Sans','Terminal+Dosis+Light','The+Girl+Next+Door','Tienne','Tinos','Tulpen+One','Ubuntu','Ultra','UnifrakturCook:bold','UnifrakturMaguntia','Unkempt','Unna','VT323','Varela','Varela+Round','Vibur','Vidaloka','Volkhov','Vollkorn','Voltaire','Waiting+for+the+Sunrise','Wallpoet','Walter+Turncoat','Wire+One','Yanone Kaffeesatz','Yellowtail','Yeseva+One','Zeyada');
...
class UDESIGN_Theme_Options {
	...
	function init_udesign_theme_options() {
		...
		add_option( "udesign_options",
		    array( // intitialize the 'udesign_options' array with the following key => value pairs:
			    ...
			    "pm_slide_img_url_1" => "940x360_slide_01.jpg",
			    ...
			    "recaptcha_lang" => "en",
			    "copyright_message" => '&copy; 2011 <strong>U-Design</strong>',
	...
	function udesign_generate_options_page() {
		...
		if ( $_REQUEST['updated'] ) echo '<div id="message" class="updated fade"><p><strong>'.esc_html__('Settings saved.', 'udesign').'</strong></p></div>';
		//if ( $_REQUEST['reset'] ) echo '<div id="message" class="updated fade"><p><strong>'.esc_html__('Settings reset.', 'udesign').'</strong></p></div>'; ?>
		<div id="udesign-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px;"><?php printf( __('Options <small>(version %1$s)</small>', 'udesign'), '1.3.1' ); ?></h2>
<?php 
...
<?php					    do_meta_boxes($this->pagehook, 'additional', $options); ?>
					    <fieldset style="margin:2px 0 0;"><legend class="screen-reader-text"><span><?php esc_attr_e('Reset to defaults', 'udesign') ?></span></legend>
...
<?php	}
	...
	function validate_options( $input ) {
		...
		if( $input['enable_google_web_fonts'] != 'yes' ) { // if disabled clear the 'google_web_fonts_assoc' array
			foreach ( $input['google_web_fonts_assoc'] as $font_application => $font_name ) {
			    $input[$font_application] = 'Arial'; // assign all locations previously assigned to some Google WebFont to 'Arial'
			}
	...
	function help_options_contentbox( $options ) { ?>
		...
		<ul style="list-style-type:none; margin:5px 5px 10px 20px;">
		    <li><?php echo '<div><a href="'.get_bloginfo('template_url').'/scripts/documentation/index.html?KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=680" class="thickbox" title="Documentation">'.esc_html__('Documentation', 'udesign').'</a></div>'; ?></li>
		    <li><?php echo '<div><a href="'.get_bloginfo('template_url').'/scripts/documentation/index.html" title="Open Documentation in a new window..."  target="_blank">'.esc_html__('Documentation (new window)', 'udesign').'</a></div>'; ?></li>
		    ...
		    <li><?php echo '<div><a href="http://themeforest.net/user/internq7/" target="_blank">'.esc_html__('Contact the Author', 'udesign').'</a></div>'; ?></li>
		</ul>
<?php	}
	...
	function general_options_contentbox( $options ) {
		...
		<table class="form-table">
			...
			<tr valign="top">
			    ...
			    <td>
				<input name="udesign_options[top_page_phone_number]" type="text" id="top_page_phone_number" value="<?php if ($options['top_page_phone_number']) { echo esc_attr($options['top_page_phone_number'], 'udesign'); } ?>" size="30" maxlength="300" />
			...
			<tr valign="top">
				...
				<label for="enable_feedback">
				    ...
				    <?php esc_html_e('Enable Feedback button (Display the Feedback button locatated in the most left side of the site)', 'udesign'); ?>
				</label><br />
			...
			<tr valign="top">
				...
				<?php printf( __('Enable %1$sprettyPhoto%2$s script. In case of conflicts with some other lightbox plugins you may wish to disable the %1$sprettyPhoto%2$s script. This script is automatically disabled if you installed and activated the %3$sWP-prettyPhoto%4$s plugin.', 'udesign'), '<a href="http://www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone/" target="_blank" title="Go to prettyPhoto website">', '</a>', '<a href="http://wordpress.org/extend/plugins/wp-prettyphoto/" target="_blank" title="Go to WP-prettyPhoto plugin website">', '</a>'); ?>
				</label>
			    </td>
			</tr>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Exclude Pages From Menu', 'udesign'); ?></th>
			    <td>
				<?php printf( __('If you have setup your menu through %1$sAppearance -> Menus%2$s, then you can ignore this option. Please select the page(s) you would like to be excluded from the top navigation menu. This option will NOT affect the settings in the new WordPress 3.0+ Menu option.', 'udesign'), '<a href="nav-menus.php">', '</a>'); ?><br />
...
<?php				    foreach ($pages_array as $page_obj) :
					$cur_page_ID = $page_obj->ID; ?>
					<input name="udesign_options[exclude_page_from_menu_<?php echo $cur_page_ID; ?>]" type="checkbox" id="exclude_page_from_menu_<?php echo $cur_page_ID; ?>" value="yes" <?php checked('yes', $options['exclude_page_from_menu_'.$cur_page_ID]); ?> />
					<strong><?php echo $page_obj->post_title; ?></strong> (<?php esc_html_e('page ID:', 'udesign'); ?> <strong><?php echo $cur_page_ID; ?></strong>)<br />
<?php				    endforeach; ?>
				</div>
				<span class="description"><?php esc_html_e('Keep in mind that if you exclude a page that has descendants (children pages), they will automatically be excluded from the menu as well!', 'udesign'); ?></span>
			    </td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<label for="show_menu_auto_arrows">
				    ...
				    <?php esc_html_e("Show the top navination menu's auto arrows. Those are the arrows indicating a submenu. ", 'udesign'); ?>
				</label>
				</fieldset>
			    </td>
			</tr>
			...
			<tr valign="top">
				...
				<label for="show_comments_on_pages">
				    ...
				    <?php esc_html_e("Show Comments on Pages. Those are the pages assigned with the 'Default Page', 'Page Template 2', 'Page Template 3' and 'Page Template 4' templates. Additionally, you can 'Allow' these comments from the individual page's configuration.", 'udesign'); ?>
				</label>
				</fieldset>
			    </td>
			</tr>
	...
	function font_settings_contentbox( $options ) {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<?php esc_html_e('Preview the available fonts at', 'udesign'); ?> <a href="http://code.google.com/webfonts" target="_blank"> Google Font Directory</a>.
				<br />
...
<?php		if ( $options['custom_colors_switch'] == 'enable' ) : ?>
		    ...
		    <h2 style="color:#2680AA; margin-top: 2px; padding:20px 10px 0;"><?php esc_html_e('Top Section Colors:', 'udesign'); ?></h2>
		    <table class="form-table">
			<tbody>
			    <tr valign="top">
				...
				<td>
				    ...
				    <?php esc_html_e("Site's top section background color. This is the section with the logo, logan, phone number and search box, immidietly above the menu.", 'udesign'); ?>
				</td>
			    </tr>
			</tbody>
		    </table>
...
<?php		    display_save_changes_button(); ?>
		    ...
		    <div style="margin:10px;">
                        ...
                        <table class="form-table" style="background-color:#F9F9F9; border:1px solid #F5F5F5;">
                            <tbody>
                                <tr valign="top">
                                    <th scope="row" style="line-height:18px;"><?php esc_html_e('Home Page Header Background Image', 'udesign'); ?></th>
                                    <td>
                                        <div style="padding:0; float:left;">
                            ...
                            <tbody>
                                <tr valign="top">
                                    ...
                                    <td>
                                        ...
                                        <div class="clear"></div>
                                        <div><span class="description" style="color:#A60000;"><?php printf( __('For Background color  %1$sTop Area Background %2$s%3$s  will be used.', 'udesign'), '<a title="Go To Top Area Background..." href="#topBGcolorSelector">', '&rarr;', '</a>'); ?></span></div>
...
<?php		    display_save_changes_button(); ?>
		    ...
		    <div style="margin:20px 10px 17px; padding:20px; display:block; background-color:#F8F8F1; border:1px solid #DDD;">
		...
		<table class="form-table" style="background-color:#F9F9F9; border:1px solid #DDDDDD;">
			...
			<tr valign="top">
				...
				<select name="udesign_options[current_slider]" id="current_slider">
				    <option value="1"<?php echo ($current_slider == '1') ? ' selected="selected"' : ''; ?>><?php esc_html_e('1. Flashmo Grid Slider', 'udesign'); ?></option>
				    <option value="2"<?php echo ($current_slider == '2') ? ' selected="selected"' : ''; ?>><?php esc_html_e('2. Piecemaker', 'udesign'); ?></option>
				    <option value="3"<?php echo ($current_slider == '3') ? ' selected="selected"' : ''; ?>><?php esc_html_e('3. Piecemaker 2', 'udesign'); ?></option>
				    <option value="4"<?php echo ($current_slider == '4') ? ' selected="selected"' : ''; ?>><?php esc_html_e('4. Cycle 1 (full width image)', 'udesign'); ?></option>
				    <option value="5"<?php echo ($current_slider == '5') ? ' selected="selected"' : ''; ?>><?php esc_html_e('5. Cycle 2 (image with text)', 'udesign'); ?></option>
				    <option value="6"<?php echo ($current_slider == '6') ? ' selected="selected"' : ''; ?>><?php esc_html_e('6. Cycle 3 (image with sliding text)', 'udesign'); ?></option>
				    <option value="7"<?php echo ($current_slider == '7') ? ' selected="selected"' : ''; ?>><?php esc_html_e('7. No Slider', 'udesign'); ?></option>
				</select>
				<div class="clear"></div>
				<div class="submit" style="padding:10px 0 0 80px; float:left; clear:both;">
				    <input type="hidden" id="udesign_submit" value="1" name="udesign_submit"/>
...
<?php		if ( $current_slider == '1' ) :
    ...
    <?php		    foreach( $gs_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<div class="gs_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					    <label for="gs_slide_img_url_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Image:', 'udesign'); ?></label>
					    <input name="udesign_options[gs_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="gs_slide_img_url_<?php echo $slide_row_number; ?>" name="udesign_options[gs_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['gs_slide_img_url_'.$slide_row_number]){ echo esc_url($options['gs_slide_img_url_'.$slide_row_number]); }?>" size="40" />
					</div>
    ...
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
				    <div class="gs_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					<label for="gs_slide_img_url_999" style="font-weight:bold;"><?php esc_html_e('Image:', 'udesign'); ?></label>
					<input name="udesign_options[gs_slide_img_url_999]" type="text" id="gs_slide_img_url_999" name="udesign_options[gs_slide_img_url_999]" value="" size="40" />
				    </div>
...
<?php		elseif ( $current_slider == '2' ) :
			...
			<tbody>
				...
				<td>
				    ...
				    <span><?php esc_html_e('To which extend are the cubes moved on z axis when being tweened. Negative values bring the cube closer to the camera, positive values take it further away. A good range is roughly between -200 and 700.', 'udesign'); ?></span>
				</td>
			    </tr>
			    <tr valign="top">
				...
				<td>
				    ...
				    <span><?php esc_html_e('To which extend are the cubes moved away from each other when tweening.', 'udesign'); ?></span>
				</td>
			    </tr>
			    <tr valign="top">
				...
				<td>
				    ...
				    <span><?php esc_html_e('To which extend are the sides shadowed, when the elements are tweening and the sided move towards the background. 100 is black, 0 is no darkening.', 'udesign'); ?></span>
				</td>
			    </tr>
			    <tr valign="top">
...
<?php			    foreach( $pm_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<p style="font-weight:bold;"><?php esc_html_e('Edit the info text, erase all for none:', 'udesign'); ?></p>
					...
					<p><span class="description" style="margin:20px 0;"><?php esc_html_e("Study the above text for slider's specific syntax", 'udesign'); ?></span></p>
				    </td>
				    <td style="padding:0 5px; width:20%" valign="top">
					<p style="font-weight:bold;"><?php esc_html_e('Upload Slide:', 'udesign'); ?></p>
					<input id="pm_slide_img_url_<?php echo $slide_row_number; ?>" name="udesign_options[pm_slide_img_url_<?php echo $slide_row_number; ?>]" style=" margin: 5px 0;" type="text" size="20"
...
<?php			    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:0 5px; width:20%" valign="top">
				    <p style="font-weight:bold;"><?php esc_html_e('Upload Slide:', 'udesign'); ?></p>
				    <input id="pm_slide_img_url_999" name="udesign_options[pm_slide_img_url_999]" style=" margin: 5px 0;" type="text" size="20" value="" />
				    <div class="uploadify" style="padding-top:7px;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
...
<?php					// If Image Slide
					if ( $options['pm2_slide_type_'.$slide_row_number] == 'image') : ?>
						<div class="pm2_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
						    ...
						    <input name="udesign_options[pm2_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="pm2_slide_img_url_<?php echo $slide_row_number; ?>" name="udesign_options[pm2_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['pm2_slide_img_url_'.$slide_row_number]){ echo esc_url($options['pm2_slide_img_url_'.$slide_row_number]); }?>" size="50" />
						</div>
						<div class="uploadify" style="padding-top:7px; width: 120px; float:left; display:inline;">
						    <input type="file" name="uploadify-<?php echo $slide_row_number; ?>" id="uploadify-<?php echo $slide_row_number; ?>" />
						</div>
...
<?php					// If Flash Slide
					elseif ( $options['pm2_slide_type_'.$slide_row_number] == 'flash') : ?> 
						...
						<div class="clear" style=""><span class="description" style="margin:20px 0; line-height:1.5; font-size:10px;"><?php esc_html_e('(Preview image to be loaded before the SWF file is shown)', 'udesign'); ?></span></div>
						<div class="file-uploaded" id="file-uploaded-<?php echo $slide_row_number; ?>" style="clear:both; padding-left:5px; line-height:24px; color:green"></div>
...
<?php					// If Video Slide
					elseif ( $options['pm2_slide_type_'.$slide_row_number] == 'video') : ?>
						...
						<div class="clear" style=""><span class="description" style="margin:20px 0; line-height:1.5; font-size:10px;"><?php esc_html_e('(Preview image to be loaded before the Video file is shown)', 'udesign'); ?></span></div>
						<div class="file-uploaded" id="file-uploaded-<?php echo $slide_row_number; ?>" style="clear:both; padding-left:5px; line-height:24px; color:green"></div>
						<div class="pm2_slide_img_title" style="padding:10px 0 0; clear:both;">
						    <label for="pm2_slide_img_title_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Title Attribute:', 'udesign'); ?> </label>
						    <input name="udesign_options[pm2_slide_img_title_<?php echo $slide_row_number; ?>]" type="text" id="pm2_slide_img_title_<?php echo $slide_row_number; ?>" value="<?php echo esc_attr($options['pm2_slide_img_title_'.$slide_row_number]); ?>" size="40" /><br />
...
<?php			    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
					...
					<input name="udesign_options[pm2_slide_img_url_999]" type="text" id="pm2_slide_img_url_999" name="udesign_options[pm2_slide_img_url_999]" value="" size="50" />
				    </div>
				    <div class="uploadify" style="padding-top:7px; float:left; display:inline;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
				    ...
				    <div class="clear" style=""><span class="description" style="margin:20px 0; line-height:1.5; font-size:10px;"><?php esc_html_e('(Preview image to be loaded before the SWF file is shown)', 'udesign'); ?></span></div>
				    <div class="file-uploaded" id="file-uploaded-999" style="clear:both; padding-left:5px; line-height:24px; color:green"></div>
				    <div class="pm2_slide_img_title" style="padding:10px 0 0; clear:both;">
...
<?php		elseif ( $current_slider == '4' ) :
    ...
    <?php		    foreach( $c1_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<p style="font-weight:bold;"><?php esc_html_e('Slide Image:', 'udesign'); ?></p>
					<textarea style="width: 98%; font-size: 12px;" id="c1_slide_img_url_<?php echo $slide_row_number; ?>" rows="2" cols="60" name="udesign_options[c1_slide_img_url_<?php echo $slide_row_number; ?>]"><?php if ($options['c1_slide_img_url_'.$slide_row_number]){ echo esc_url($options['c1_slide_img_url_'.$slide_row_number]); }?></textarea><br />
    ...
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:0 10px 10px 20px; width:100%" valign="top">
				    <p style="font-weight:bold;"><?php esc_html_e('Slide Image:', 'udesign'); ?></p>
				    <textarea style="width: 98%; font-size: 12px;" id="c1_slide_img_url_999" rows="2" cols="60" name="udesign_options[c1_slide_img_url_999]"></textarea><br />
    ...
    <?php		    foreach( $c2_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<div class="c2_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					    <label for="c2_slide_img_url_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Image:', 'udesign'); ?></label>
					    <input name="udesign_options[c2_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="c2_slide_img_url_<?php echo $slide_row_number; ?>" name="udesign_options[c2_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['c2_slide_img_url_'.$slide_row_number]){ echo esc_url($options['c2_slide_img_url_'.$slide_row_number]); }?>" size="40" />
					</div>
					<div class="uploadify" style="padding-top:7px; width: 120px; float:left; display:inline;">
					    <input type="file" name="uploadify-<?php echo $slide_row_number; ?>" id="uploadify-<?php echo $slide_row_number; ?>" />
					</div>
					...
					<div class="slide-button" style="padding-top:10px; float:left; display:inline; width:35%">
					    ...
					    <span class="description" style="float:left;padding:5px; display:block; line-height:17px;"><?php _e('The button is activated only if a <strong>Link</strong> is provided.', 'udesign'); ?></span>
					</div>
				    </td>
				</tr>
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
				    <div class="c2_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					<label for="c2_slide_img_url_999" style="font-weight:bold;"><?php esc_html_e('Image:', 'udesign'); ?></label>
					<input name="udesign_options[c2_slide_img_url_999]" type="text" id="c2_slide_img_url_999" name="udesign_options[c2_slide_img_url_999]" value="" size="40" />
				    </div>
				    <div class="uploadify" style="padding-top:7px; float:left; display:inline;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
...
<?php		elseif ( $current_slider == '6' ) :
    ...
    <?php		    foreach( $c3_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<div class="c3_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					    <label for="c3_slide_img_url_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Image:', 'udesign'); ?></label>
					    <input name="udesign_options[c3_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="c3_slide_img_url_<?php echo $slide_row_number; ?>" name="udesign_options[c3_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['c3_slide_img_url_'.$slide_row_number]){ echo esc_url($options['c3_slide_img_url_'.$slide_row_number]); }?>" size="40" />
					</div>
					<div class="uploadify" style="padding-top:7px; width: 120px; float:left; display:inline;">
					    <input type="file" name="uploadify-<?php echo $slide_row_number; ?>" id="uploadify-<?php echo $slide_row_number; ?>" />
					</div>
					...
					<div id="c3_slide_link_url_<?php echo $slide_row_number; ?>" class="slide-link" style="padding:5px 5px 10px 0; clear:both;">
						...
						<select name="udesign_options[c3_slide_link_target_<?php echo $slide_row_number; ?>]" id="c3_slide_link_target_<?php echo $slide_row_number; ?>">
						    ...
						    <option value="blank"<?php echo ($options['c3_slide_link_target_'.$slide_row_number] == 'blank') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('blank', 'udesign'); ?></option>
                                            ...
                                            <br /><span style="line-height: 1.5; font-size: 10px; float:left;" class="description" style="margin:5px 0;float:left;"><?php esc_html_e('(To delete the link, replace it with a single space)', 'udesign'); ?></span>
					</div>

                                        <div class="c3_slide_img2_url" style="padding:10px 5px 0 0; float:left; display:inline; clear:left;">
                                            <label for="c3_slide_img2_url_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Image 2:', 'udesign'); ?></label>
                                            <input name="udesign_options[c3_slide_img2_url_<?php echo $slide_row_number; ?>]" type="text" id="c3_slide_img2_url_<?php echo $slide_row_number; ?>" name="udesign_options[c3_slide_img2_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['c3_slide_img2_url_'.$slide_row_number]){ echo esc_url($options['c3_slide_img2_url_'.$slide_row_number]); }?>" size="40" />
                                        </div>
                                        <div class="uploadify2" style="padding-top:7px; float:left; display:inline;">
                                            <input type="file" name="uploadify2-<?php echo $slide_row_number; ?>" id="uploadify2-<?php echo $slide_row_number; ?>" />
                                        </div>
                                        <div id="file2-uploaded-<?php echo $slide_row_number; ?>" class="file2-uploaded" style="clear:both; padding-left:5px; line-height:24px; color:green"></div>
    ...
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
				    <div class="c3_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					<label for="c3_slide_img_url_999" style="font-weight:bold;"><?php esc_html_e('Image:', 'udesign'); ?></label>
					<input name="udesign_options[c3_slide_img_url_999]" type="text" id="c3_slide_img_url_999" name="udesign_options[c3_slide_img_url_999]" value="" size="40" />
				    </div>
				    <div class="uploadify" style="padding-top:7px; float:left; display:inline;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
					...
					<label for="c3_slide_link_target_999" class="link-target">
						...
						<select name="udesign_options[c3_slide_link_target_999]" id="c3_slide_link_target_999">
						    ...
						    <option value="blank"><?php esc_attr_e('blank', 'udesign'); ?></option>
                                    ...
                                    <div class="c3_slide_img2_url" style="padding:10px 5px 0 0; float:left; display:inline; clear:left;">
                                        <label for="c3_slide_img2_url_999" style="font-weight:bold;"><?php esc_html_e('Image 2:', 'udesign'); ?></label>
                                        <input name="udesign_options[c3_slide_img2_url_999]" type="text" id="c3_slide_img2_url_999" name="udesign_options[c3_slide_img2_url_999]" value="" size="40" />
                                    </div>
                                    <div class="uploadify2" style="padding-top:7px; float:left; display:inline;">
                                        <input type="file" name="uploadify2-999" id="uploadify2-999" />
                                    </div>
                                    <div id="file2-uploaded-999" class="file2-uploaded" style="clear:both; padding-left:5px; line-height:24px; color:green"></div>
...
<?php		elseif ( $current_slider == '7' ) : // No slider ?>
			...
			<tbody>
			    <tr valign="top">
				<th scope="row"><?php esc_html_e('"No Slider" Text', 'udesign'); ?></th>
				<td>
				    <?php esc_html_e('Change the phrase:', 'udesign'); ?> <input name="udesign_options[no_slider_text]" type="text" id="no_slider_text" value="<?php if ($options['no_slider_text']) { echo esc_attr($options['no_slider_text']); } ?>" size="35" maxlength="120" />
				    <br />
	...
	function portfolio_section_options_contentbox( $options ) {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<?php esc_html_e("If you don't see any categories in the dropdown(s) below it's because you haven't created any yet, in that case go to 'Posts -> Categories' and create a 'Portfolio' category there. Also don't forget to save all your Portfolio related Posts and sub categories under that category.", 'udesign'); ?><br />
...
<?php				endforeach; ?>
		...
		<div class="form-table" style="background-color:#F9F9F9; border:1px solid #DDDDDD; margin-bottom:5px;">
		    <p style="padding:20px 5px 10px;"><?php esc_html_e('The following settings refer to the individual portfolio item post which is usually accessed by slicking on a portfoilo item title or "read more..." link (if present).', 'udesign'); ?></p>
		    <table>
			<tbody>
			    <tr valign="top">
				...
				<td>
				    ...
				    <span class="description"><?php esc_html_e("This is the sidebar shown on individual portflio items' posts", 'udesign'); ?></span>
				</td>
			    </tr>
			    <tr valign="top">
				<th scope="row"><?php esc_html_e('Portfolio Post Metadata', 'udesign'); ?></th>
				<td>
				    <fieldset><legend class="screen-reader-text"><span><?php esc_html_e('Portfolio Post Metadata', 'udesign'); ?></span></legend>
					...
					<span class="description"><?php esc_html_e('This is the info box situated right under the post and just above the comments area.', 'udesign'); ?></span>
				    </label>
				    </fieldset>
				</td>
			    </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <label for="force_image_dimention">
                                        ...
                                        <?php esc_html_e('Select this option to crop and resize the image with TimThumb script which is recommended if you would like all images to be of the same dimensions, otherwise the built-in WordPress resizing will be applied to the "Featured Image".', 'udesign'); ?><br />
                                    </label>
                                    </fieldset>
                                </td>
                            </tr>
	...
	function contact_page_options_contentbox( $options ) {
		...
		<p style="margin:5px 20px">
		    ...
		    <input name="udesign_options[contact_field_name1]" type="text" id="contact_field_name1" value="<?php if ($contact_field_name1){echo esc_attr($contact_field_name1);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value1]" type="text" id="contact_field_value1" value="<?php if ($contact_field_value1){echo esc_attr($contact_field_value1);}?>" size="50" maxlength="70" /><br/>
		    ...
		    <input name="udesign_options[contact_field_name2]" type="text" id="contact_field_name2" value="<?php if ($contact_field_name2){echo esc_attr($contact_field_name2);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value2]" type="text" id="contact_field_value2" value="<?php if ($contact_field_value2){echo esc_attr($contact_field_value2);}?>" size="50" maxlength="70" /><br/>
		    ...
		    <input name="udesign_options[contact_field_name3]" type="text" id="contact_field_name3" value="<?php if ($contact_field_name3){echo esc_attr($contact_field_name3);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value3]" type="text" id="contact_field_value3" value="<?php if ($contact_field_value3){echo esc_attr($contact_field_value3);}?>" size="50" maxlength="70" /><br/>
		    ...
		    <input name="udesign_options[contact_field_name4]" type="text" id="contact_field_name4" value="<?php if ($contact_field_name4){echo esc_attr($contact_field_name4);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value4]" type="text" id="contact_field_value4" value="<?php if ($contact_field_value4){echo esc_attr($contact_field_value4);}?>" size="50" maxlength="70" /><br/>
		    ...
		    <input name="udesign_options[contact_field_name5]" type="text" id="contact_field_name5" value="<?php if ($contact_field_name5){echo esc_attr($contact_field_name5);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value5]" type="text" id="contact_field_value5" value="<?php if ($contact_field_value5){echo esc_attr($contact_field_value5);}?>" size="50" maxlength="70" /><br/>
		    ...
		    <input name="udesign_options[contact_field_name6]" type="text" id="contact_field_name6" value="<?php if ($contact_field_name6){echo esc_attr($contact_field_name6);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value6]" type="text" id="contact_field_value6" value="<?php if ($contact_field_value6){echo esc_attr($contact_field_value6);}?>" size="50" maxlength="70" /><br/>
		    ...
		    <input name="udesign_options[contact_field_name7]" type="text" id="contact_field_name7" value="<?php if ($contact_field_name7){echo esc_attr($contact_field_name7);}?>" size="30" maxlength="50" />
			     <input name="udesign_options[contact_field_value7]" type="text" id="contact_field_value7" value="<?php if ($contact_field_value7){echo esc_attr($contact_field_value7);}?>" size="50" maxlength="70" /><br/><br/>
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<label for="recaptcha_enabled">
				    ...
				    <?php printf( esc_html__('Add ReCAPTCHA to the email form for extra security (for more information visit %s)', 'udesign'), '<a href="http://recaptcha.net/" target="_blank">www.recaptcha.net</a>' ); ?>
				</label><br />
			...
			<tr valign="top">
				...
				<br /><?php esc_html_e('To use reCAPTCHA you must get an API public key from', 'udesign'); ?> <a href="http://recaptcha.net/" target="_blank">http://recaptcha.net</a>
			    </td>
			</tr>
			<tr valign="top">
				...
				<br /><?php esc_html_e('To use ReCAPTCHA you must get an API private key from', 'udesign'); ?> <a href="http://recaptcha.net/" target="_blank">http://recaptcha.net</a><br />
	...
	function statistics_options_contentbox( $options ) {
		...
		<table class="form-table">
			...
			<td>
			    ...
			    <br />
			    <span class="description"><?php esc_html_e('Paste your Google Analytics or other tracking code here. It will be inserted just before the closing body tag for every page', 'udesign'); ?></span>
			</td>
			</tr>
		    </tbody>
		</table>
