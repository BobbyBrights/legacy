...
<?php                           foreach( $c3_slides_array as $slide_row_number ) :
					...
					<div class="c3-slide-img-wrapper">
                                            <img src="<?php echo $udesign_options['c3_slide_img_url_'.$slide_row_number]; ?>" alt="" class="slide-img" width="940" height="382" />
					</div>
<?php                                   if ( $c3_slide_img2_url != '' ) : ?>
                                            <div class="sliding-image">
                                                <img src="<?php echo $c3_slide_img2_url; ?>" alt="" class="slide-img" width="940" height="382" />
                                            </div>
<?php                                   endif; ?>
