...
function yoko() {
	...
	add_image_size( 'slider-image', 720, 382, true); // Permalink thumbnail size 
...
function site_init(){
	// Sidebars
	register_sidebar( array(
			'id'          => 'home-header-section',
			'name'        => __( 'Slider Section', $text_domain ),
			'description' => __( 'This sidebar is located below the header section. Used for sliders', $text_domain ),
			'before_widget' => '<div id="%1$s" class="sidebarcolumn widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3>',
			'after_title' => '</h3>'
		));
	...
	register_sidebar( array(
			...
			'name'        => __( 'Home Content Section', $text_domain ),
			'description' => __( 'This sidebar is for homepage content', $text_domain ),
			'before_widget' => '<div id="%1$s" class="sidebarcolumn widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="text_module">',
			'after_title' => '</div>'
		));

	register_sidebar( array(
			'id'          => 'home-links-section',
			'name'        => __( 'Home Links Section', $text_domain ),
			'description' => __( 'This sidebar is for homepage content for links', $text_domain ),
			'before_widget' => '<div id="%1$s" class="rhs-content widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3>',
			'after_title' => '</h3>'
		));
	...
	register_sidebar( array(
			'id'          => 'header-ancillary-menu',
			'name'        => __( 'Header Ancillary Menu', $text_domain ),
			'description' => __( 'This widget area to be used for ancillary menu items (top left page)', $text_domain ),
			'before_widget' => '<div id="%1$s" class="header-ancillary %2$s">',
			'after_widget' => '</div>',
			'before_title' => '',
			'after_title' => ''
		));
	register_sidebar( array(
			'id'          => 'single-post-rhs',
			'name'        => __( 'Single Post - Right hand side', $text_domain ),
			'description' => __( 'This widget area to be used for rhs content on single posts.', $text_domain ),
			'before_widget' => '<div id="%1$s" class="single-post-rhs %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3>',
			'after_title' => '</h3>'
		));
	...
	register_sidebar( array(
			'id'          => 'page-rhs',
			'name'        => __( 'Page - Right hand side', $text_domain ),
			'description' => __( 'This widget area to be used for rhs content on pages.', $text_domain ),
			'before_widget' => '<div id="%1$s" class="single-post-rhs %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h3>',
			'after_title' => '</h3>'
...
function rewrite_init() {
    global $wp_rewrite;
    //$wp_rewrite->add_permastruct('publications', 'publications/', true, 1);
    add_rewrite_rule('publications/(.+)/?$', 'index.php?publications=$matches[2]', 'top');
