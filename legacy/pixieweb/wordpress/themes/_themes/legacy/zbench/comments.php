...
<!-- You can start editing here. -->
	...
	<?php if ( have_comments() ) { ?>
			...
			<ol class="commentlist" id="thecomments">
					<?php wp_list_comments('type=comment&callback=zbench_mytheme_comment'); ?>
			</ol>
...
if ($zbench_options['smilies'] != 'true') { ?>
	...
	$comment_notes='<p class="comment-note">' . __('NOTE - You can use these ','zbench') . sprintf(('<abbr title="HyperText Markup Language">HTML</abbr> tags and attributes:<br />%s' ), ' <code>' . allowed_tags() . '</code>' ) . '</p>';
