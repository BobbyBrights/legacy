...
load_theme_textdomain('pandora', TEMPLATEPATH.'/translation' );
...
pandora_always_white_bg_content();
...
wp_enqueue_script('jquery_framework', 'http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js');

//slider functions
require_once (TEMPLATEPATH . '/functions/slider.php');

//logo functions
require_once (TEMPLATEPATH . '/functions/logo.php');

//main menu functions and registers
require_once (TEMPLATEPATH . '/functions/main-menu.php');

//the lightbox function for all images
//require_once (TEMPLATEPATH . '/functions/lightbox.php'); //turned off - not WP-jquery valid plugin, it is generate some bug on many plugins

//page list function
require_once (TEMPLATEPATH . '/functions/page-list.php');

//user's avatar and description in author.php
require_once (TEMPLATEPATH . '/functions/user-desc.php');

//error, warning, alert, poup up messages functions
require_once (TEMPLATEPATH . '/functions/windows.php');

//call admin area for options
require_once (TEMPLATEPATH . '/extendeds/admin/admin_panel.php');
