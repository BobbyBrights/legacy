<?php get_header(); ?>
	...
	<div class="container">
		<div class="content content-mini">
			...
			<h2 class="page-title author"><?php printf( __( 'Author Archives: <span class="vcard">%s</span>', 'pandora' ), "<a class='url fn n' href='$authordata->user_url' title='$authordata->display_name' rel='me'>$authordata->display_name</a>" ) ?></h2>
			<div class="entry-content-container user-panel">
				<p><?php echo pandora_user_author_panel(); ?></p>
			</div>
