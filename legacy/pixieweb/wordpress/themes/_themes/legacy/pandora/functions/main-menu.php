<?php
wp_enqueue_style('pandora_menu', get_template_directory_uri() . '/jquery/menu/superfish.css');
wp_enqueue_script('pandora_js_menu', get_template_directory_uri() . '/jquery/menu/sf.js');
