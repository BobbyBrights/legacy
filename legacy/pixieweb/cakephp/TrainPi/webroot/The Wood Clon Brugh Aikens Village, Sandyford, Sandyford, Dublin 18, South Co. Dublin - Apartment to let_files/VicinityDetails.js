...
{continue;}
property.type=VicinityDetails.type;property=checkSimilarCache(property);var marker=MultiMaps.drawPropertyMarker(property);VicinityDetails.similarMarkers.push(marker);}
...
{VicinityDetails.loadingSim=true;MultiMaps.throbber("Refining search",25000);$.get("/ajax_endpoint.php",{"action":"smi_nearby_properties","type":VicinityDetails.type,"ad_id":VicinityDetails.AdId,"sw":"("+sw.lat+", "+sw.lng+")","ne":"("+ne.lat+", "+ne.lng+")","extra_params":"[]"},VicinityDetails.updateMapProperties);}
else
