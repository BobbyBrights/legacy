...
{rotateDFP();}});$('.smi-gallery .smi-photo a.p1').click(function(){pb_open=true;tb_show(null,'#TB_inline?inlineId=photo_browser&width='+pbWidth+'&height=627',null);});$('.smi-gallery .smi-photo a.v1').click(function(){tb_show(null,vb_url,null);});$('.smi-gallery .smi-photo a.v2').click(function(){tb_show(null,vt_url,null);});$('#sts').hover(function(){$(this).css({cursor:'pointer',color:'#fe7c00'});},function(){$(this).css({color:'#2b2ae8'});});$('#sts').click(function(){tb_show(null,tips_url,null);});if(ad_type.indexOf('international')==-1)
