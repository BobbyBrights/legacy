<?php $link_options = array('controller' => 'feeds_categories', 'action' => 'add'); ?>
...
<table class="table table-striped">
  <thead>
    <tr>
        ...
        <th class="span5"><?php echo $this->Paginator->sort('summary', 'Summary'); ?></th>
        <th><?php echo $this->Paginator->sort('Feed.name', 'Feed'); ?></th>
        <th class="span3"><?php echo $this->Paginator->sort('created', 'Created on'); ?></th>
    </tr>
  </thead>
  <tbody>
